...
#include "../../source/SHARED_/NormalizePath.hpp"
...
{
        REQUIRE(Pretop::Utils::NormalizePath(
                    "assets//test///player.png") == "assets/test/player.png");

        REQUIRE(Pretop::Utils::NormalizePath(
                    "///assets/player.png") == "/assets/player.png");
}
...
{
        REQUIRE(Pretop::Utils::NormalizePath(
                    "assets/test/../../player.png") == "player.png");

        REQUIRE(Pretop::Utils::NormalizePath(
                    "a/b/../../player.png") == "player.png");

        REQUIRE(Pretop::Utils::NormalizePath(
                    "a/../../player.png") == "../player.png");
}
...
{
        REQUIRE(Pretop::Utils::NormalizePath(
                    "..hidden/player.png") == "..hidden/player.png");

        REQUIRE(Pretop::Utils::NormalizePath("file..txt") == "file..txt");

        REQUIRE(Pretop::Utils::NormalizePath(
                    "test.../player.png") == "test.../player.png");
...
{
        REQUIRE(Pretop::Utils::NormalizePath(
                    "assets/my player.png") == "assets/my player.png");
